...
#
#     start_arr = converter.text_to_arr(FLAGS.start_string)
#     total_arr = model.sample(FLAGS.max_length, start_arr, converter.vocab_size)
#     print(converter.arr_to_text(total_arr))
#
#
